  ...
  if (success) {
    return (
      <div className="min-h-screen bg-black flex items-center justify-center font-['Helvetica_Neue',Arial,sans-serif]">
        <div className="text-center p-8 border border-white/10 rounded-sm bg-white/5 backdrop-blur-xl">
      ...
      <div ref={formRef} className="relative z-10 w-full max-w-[400px] px-6 py-12">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-[10px] tracking-[0.3em] text-white/30 uppercase">
            Create your bespoke 3D identity
          </p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-6">
          <div className="space-y-6">
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-transparent border-b border-white/10 py-3 text-xs text-white font-light tracking-wide outline-none transition-all focus:border-white/40 placeholder:text-white/5"
            ...
            <div className="relative group">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-transparent border-b border-white/10 py-3 text-xs text-white font-light tracking-wide outline-none transition-all focus:border-white/40 placeholder:text-white/5 pr-10"
                  placeholder="••••••••"
                  required
                />
                <button
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full relative py-4 mt-4 text-[11px] tracking-[0.3em] text-black bg-white uppercase font-normal rounded-sm transition-all hover:bg-gray-200 active:scale-[0.98] disabled:opacity-50"
          >
