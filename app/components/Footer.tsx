        ...
        <footer className="bg-black border-t border-white/10" suppressHydrationWarning>
            ...
            <div className="max-w-7xl mx-auto px-8 py-16" suppressHydrationWarning>
                ...
                <div className="flex justify-center gap-6 mb-12">
                    <a href="https://www.instagram.com/makers3d.in" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-all duration-300 hover:scale-110" suppressHydrationWarning>
                    ...
                    <div className="text-center md:text-left" suppressHydrationWarning>
                        ...
                        <div className="flex flex-col gap-4" suppressHydrationWarning>
                            ...
                            <div className="pt-4 border-t border-white/5 flex flex-col gap-2">
                                <a href="mailto:support@makers3d.in" className="text-white/40 font-thin text-[10px] tracking-widest hover:text-white transition-colors" suppressHydrationWarning>
                                    SUPPORT@MAKERS3D.IN
                                </a>
                                <a href="tel:+917863983914" className="text-white/40 font-thin text-[10px] tracking-widest hover:text-white transition-colors" suppressHydrationWarning>
                                    +91 7863983914
                                </a>
                            </div>
                        </div>
