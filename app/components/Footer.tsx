                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto" suppressHydrationWarning>
                    ...
                    <div className="text-center md:text-left" suppressHydrationWarning>
                        ...
                        <div className="flex flex-col gap-4" suppressHydrationWarning>
                            ...
                            <Link href="/exchange" className="text-white/70 font-thin text-sm tracking-wide hover:text-white transition-colors hover:translate-x-1 inline-block">
                                Exchange Portal
                            </Link>
                            <Link href="/return-policy" className="text-white/70 font-thin text-sm tracking-wide hover:text-white transition-colors hover:translate-x-1 inline-block">
                                Return Policies
                            </Link>
                            <Link href="/policies" className="text-white/70 font-thin text-sm tracking-wide hover:text-white transition-colors hover:translate-x-1 inline-block">
                                Policies
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="text-center md:text-right" suppressHydrationWarning>
                        ...
                        <div className="flex flex-col gap-4 items-center md:items-end" suppressHydrationWarning>
                            ...
                            <Link href="/terms" className="text-white/70 font-thin text-sm tracking-wide hover:text-white transition-colors hover:translate-x-1 inline-block">
                                Terms and Services
                            </Link>
                            <Link href="/partner" className="text-white/70 font-thin text-sm tracking-wide hover:text-white transition-colors hover:translate-x-1 inline-block">
                                Partner With Us
                            </Link>
                        </div>
                    </div>
